    ...
    <div className="bg-background">
        ...
        <nav className="mx-auto w-full max-w-[1200px] px-7 py-[14px]">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden items-center gap-7 text-sm text-muted md:flex">
              <a href="#services" onClick={() => trackSectionNavClick("services", "desktop")} className="transition hover:text-text">Services</a>
              <a href="#how-it-works" onClick={() => trackSectionNavClick("how-it-works", "desktop")} className="transition hover:text-text">How It Works</a>
              <a href="#case-study" onClick={() => trackSectionNavClick("case-study", "desktop")} className="transition hover:text-text">Case Study</a>
              <a href="#who-we-help" onClick={() => trackSectionNavClick("who-we-help", "desktop")} className="transition hover:text-text">Who We Help</a>
              <a href="#about" onClick={() => trackSectionNavClick("about", "desktop")} className="transition hover:text-text">About</a>
            </div>
            <a
              href={calendlyLink}
              target="_blank"
          ...
          <div className="mt-2 grid w-full grid-cols-5 gap-x-2 gap-y-1 text-center text-[11px] text-muted md:hidden">
            <a href="#services" onClick={() => trackSectionNavClick("services", "mobile")} className="transition hover:text-text">Services</a>
            <a href="#how-it-works" onClick={() => trackSectionNavClick("how-it-works", "mobile")} className="transition hover:text-text">How It Works</a>
            <a href="#case-study" onClick={() => trackSectionNavClick("case-study", "mobile")} className="transition hover:text-text">Case Study</a>
            <a href="#who-we-help" onClick={() => trackSectionNavClick("who-we-help", "mobile")} className="transition hover:text-text">Who We Help</a>
            <a href="#about" onClick={() => trackSectionNavClick("about", "mobile")} className="transition hover:text-text">About</a>
          </div>
        </nav>
      </header>
      ...
      <main>
        ...
        <MotionSection id="problems" className="relative overflow-hidden bg-surface scroll-mt-24">
          ...
          <div className="mx-auto w-full max-w-[1200px] px-5 py-14 md:px-7 md:py-[110px]">
            <h2 className="max-w-3xl text-2xl font-bold text-text sm:text-3xl">
              If any of these sound familiar, your website is costing you patients.
            </h2>
            <div className="mt-6 grid gap-4 md:mt-8 md:gap-5 md:grid-cols-3">
              {[
                ...
                >
                  ...
                  <p className="mt-3 text-[14px] leading-[1.65] text-text-bright">{item.text}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <MotionSection id="services" className="relative overflow-hidden bg-background scroll-mt-24">
          ...
          <div className="mx-auto w-full max-w-[1200px] px-5 py-14 md:px-7 md:py-[110px]">
            <h2 className="text-2xl font-bold text-text sm:text-3xl">Everything included in your plan.</h2>
        ...
        <MotionSection id="how-it-works" className="relative overflow-hidden bg-surface scroll-mt-24">
          ...
          <div className="mx-auto w-full max-w-[1200px] px-5 py-14 md:px-7 md:py-[110px]">
            <h2 className="text-2xl font-bold text-text sm:text-3xl">Simple process. Fast results.</h2>
            <div className="mt-6 grid gap-4 md:mt-8 md:gap-6 md:grid-cols-3">
              {["Free Audit 20 min", "We Build & Optimize", "You Get Patients"].map((step, index) => (
                <div key={step} className="rounded-2xl border border-[rgba(255,255,255,0.08)] bg-surface-elevated p-5 md:p-[28px]">
                  <p className="text-[13px] font-bold tracking-[0.14em] text-cyan uppercase">Step {index + 1}</p>
            ...
            <div className="mt-6 grid gap-6 md:mt-8 lg:grid-cols-[1fr_1fr] lg:gap-10 lg:items-start">
              <div className="rounded-2xl border border-[rgba(255,255,255,0.08)] bg-surface-elevated p-5 md:p-[28px]">
                <div className="flex items-start justify-between">
                  <p className="text-sm font-semibold uppercase tracking-[0.14em] text-cyan">Growth Plan</p>
                  <GradientRing size={100} />
                </div>
                <p className="mt-3 text-4xl font-bold tracking-[-0.02em] text-text">$800/mo</p>
                <p className="mt-3 text-[15px] text-text-bright">6-month commitment. Website built free at the start.</p>
                <ul className="mt-6 space-y-2 text-[15px] text-text-bright">
                  {[
                    "Professional website — designed and launched at no upfront cost",
                    "2 SEO blog articles per month",
                    "30 social media posts per month across your platforms",
                    "Monthly performance report",
                    "After 6 months, the website is yours to keep — continue or walk away",
                  ].map((item) => (
                ...
                <p className="mt-6 text-sm text-muted">No long-term contracts beyond the initial 6 months. No fluff. Just a website built to grow.</p>
                <a
                  href={calendlyLink}
                  target="_blank"
                  rel="noreferrer"
        ...
        <MotionSection id="addons" className="relative overflow-hidden bg-surface scroll-mt-24">
          ...
          <div className="mx-auto w-full max-w-[1200px] px-5 py-14 md:px-7 md:py-[110px]">
            <h2 className="text-2xl font-bold text-text sm:text-3xl">Also available.</h2>
            ...
            <div className="mt-6 grid gap-4 md:mt-8 md:gap-5 md:grid-cols-3">
              {[
                ...
                },
                {
                  ...
                  outcomes: ["Front + back, print-ready files", "Matched to your existing brand", "Unlimited revisions"],
                },
                {
                  title: "Social Media Starter Kit",
                  price: "$299",
                  turnaround: "48 hour turnaround",
                  outcomes: ["Profile photo + cover image", "5 branded post templates", "Ready to use immediately"],
                },
              ].map((addon) => (
                <div key={addon.title} className="rounded-2xl border border-[rgba(255,255,255,0.08)] bg-background p-5 md:p-[28px] transition-colors duration-200 hover:border-[rgba(255,255,255,0.14)]">
                  <div className="flex items-start justify-between">
        ...
        <MotionSection id="case-study" className="relative overflow-hidden bg-background scroll-mt-24">
          ...
          <div className="mx-auto w-full max-w-[1200px] px-5 py-14 md:px-7 md:py-[110px]">
            ...
            <h2 className="mt-3 text-2xl font-bold text-text sm:text-3xl">Real results. Real words.</h2>
            <div className="mt-6 rounded-2xl border border-[rgba(255,255,255,0.08)] bg-surface-elevated p-6 md:mt-10 md:p-[40px]">
              ...
              <p className="mt-4 text-[18px] font-bold leading-[1.5] text-text italic md:text-[22px]">
                &ldquo;I have never worked with any web firm that is this responsive, this fast, this proficient and this professional.&rdquo;
              </p>
            ...
            <div className="mt-8 text-center">
              <a
                href="/case-study"
                className="inline-flex items-center gap-2 text-[15px] font-semibold text-cyan transition hover:underline"
              >
                Read the full Juvenis Medical case study →
              </a>
              <div className="mt-6">
                <a
                  href={calendlyLink}
                  ...
                  className="inline-flex rounded-md border border-transparent bg-primary px-[22px] py-[14px] text-[15px] font-bold tracking-[-0.01em] text-text shadow-[0_0_40px_-8px_rgba(0,102,255,0.45)] transition-all duration-[180ms] hover:bg-[#3385FF]"
                >
                  Get your free website
                </a>
              </div>
        ...
        <MotionSection id="who-we-help" className="relative overflow-hidden bg-surface scroll-mt-24">
          <div className="pointer-events-none absolute -left-[5%] top-[10%] h-[70%] w-[50%] bg-[radial-gradient(ellipse,rgba(0,212,255,0.28),transparent_65%)] blur-[60px]" />
          <div className="mx-auto w-full max-w-[1200px] px-5 py-14 md:px-7 md:py-[110px]">
            <h2 className="text-2xl font-bold text-text sm:text-3xl">Built specifically for medical and wellness practices.</h2>
            <ul className="mt-8 grid gap-[14px] sm:grid-cols-2 lg:grid-cols-3">
              {["Hormone/TRT clinics", "Peptide therapy", "Functional medicine", "Weight loss/GLP-1", "Solo physicians", "Telehealth practices"].map((item) => (
                <li key={item} className="flex items-center gap-3 rounded-[10px] border border-[rgba(255,255,255,0.08)] bg-surface-elevated p-[14px] text-[15px] text-muted">
                  <span className="inline-flex h-[22px] w-[22px] items-center justify-center rounded-full border-[1.5px] border-[rgba(0,212,255,0.55)] text-[12px] text-cyan">✓</span>
                  {item}
                </li>
              ))}
            </ul>
        ...
        <MotionSection id="about" className="relative overflow-hidden bg-background scroll-mt-24">
          ...
          <div className="mx-auto grid w-full max-w-[1200px] gap-8 px-5 py-14 md:gap-[56px] md:px-7 md:py-[110px] lg:grid-cols-[320px_1fr]">
            ...
            <div>
              <h2 className="text-2xl font-bold text-text sm:text-3xl">You&apos;re working with a person, not an agency.</h2>
              <p className="mt-4 max-w-[560px] text-[16px] leading-[1.7] text-text-bright">
                I&apos;m Pete Luke - I started Peter Luke Digital because I kept seeing the same problem: medical practices with incredible doctors and real results, completely invisible online. I specialize in this space - the compliance requirements, the patient trust signals, the SEO terms that drive appointments.
              </p>
            </div>
          </div>
        </MotionSection>
        ...
        <MotionSection className="relative overflow-hidden bg-background scroll-mt-24">
          ...
          <div className="mx-auto w-full max-w-[1200px] px-5 py-14 md:px-7 md:py-[120px] text-center">
            <div className="mb-5 flex justify-center md:mb-8">
              <Image src="/assets/images/logo-primary.png" alt="Peter Luke Digital" width={120} height={120} className="h-[120px] w-[120px] object-contain" />
            </div>
            <h2 className="text-2xl font-bold text-text sm:text-4xl">Is your website losing you patients?</h2>
            <p className="mx-auto mt-4 max-w-2xl text-muted">Find out in 20 minutes - free, no obligation.</p>
            <a
              href={calendlyLink}
              target="_blank"
              rel="noreferrer"
